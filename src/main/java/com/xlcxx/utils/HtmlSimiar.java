...
/**
* 创建时间：2018年12月6日 下午4:58:42
* @author yhsh
* @version 1.0
* @since JDK 1.7.0_21
* 类说明  java 比较 两个  大量文件内容的相似度
*/
public class HtmlSimiar {
    ...
    public HtmlSimiar(String tokens) {
        this.tokens = tokens;
        this.strSimHash = this.simHash();
    }
    public HtmlSimiar(String tokens, int hashbits) {
        this.tokens = tokens;
     ...
     * @return
     */
    private int hammingDistance(HtmlSimiar other) {
    ...
    public double getSemblance(HtmlSimiar s2 ){
    ...
    public static void main(String[] args) {
        ...
        HtmlSimiar hash1 = new HtmlSimiar(s1, 64);
        HtmlSimiar hash2 = new HtmlSimiar(s2, 64);
        HtmlSimiar hash3 = new HtmlSimiar(s3, 64);
        HtmlSimiar hash4 = new HtmlSimiar(s4, 64);
        System.out.println("======================================");
        ...
        System.out.println("======================================");
        Boolean ble = Double.doubleToLongBits(hash3.getSemblance(hash4)) > Double.doubleToLongBits(0.97);
